...
1. You must have already created and uploaded an SSL cert to AWS, this can only be done via the console at this time. Once you've uploaded the cert, you will need the `ARN` of the cert resource.
